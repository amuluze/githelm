...
export const OrbitIllustration = () => (
 ...
 */
export const WindowIllustration = ({
  scale = 1,
}: {
  scale?: number;
}) => (
...
export const SkeletonListIllustration = () => (
...
export const ServerStackIllustration = () => (
...
export const RepoEmptyIllustration = () => (
